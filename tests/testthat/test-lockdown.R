...
test_that("ps_build_ttv_event fails fast on bad event times and event_type", {
  ...
  expect_error(
    ps_build_ttv_event(bad_ev_time, splits, event_type = "mi"),
    "time"
  )
  ...
  expect_error(
    ps_build_ttv_event(bad_ev_type, splits, event_type = "mi"),
    "event_type"
  )
})
